...
- Use Conventional Commits for all commits (https://www.conventionalcommits.org/) - required for release-please to work correctly
- For breaking changes, use `!` prefix (e.g., `feat!:` or `chore!: description`) and include BREAKING CHANGE footer in commit body
- Merge PRs using "Squash and merge" to ensure clean, single commits in main branch history
